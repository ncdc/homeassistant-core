...
from .apc_surgearrest import Client
...
class APCSurgeArrestUpdateCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    """DataUpdateCoordinator to gather data from APC SurgeArrest."""

    def __init__(self, hass: HomeAssistant, client: Client, entry: ConfigEntry) -> None:
